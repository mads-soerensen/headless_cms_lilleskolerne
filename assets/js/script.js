...
function contentPage(data) {
  ...
  for (i = 0; i < data.story.content.body.length; i++){
    ...
    switch (data.story.content.body[i].component){
      ...
      case "header_img" :
      headerImage += '<img class="head-img" src="' + data.story.content.body[i].image + '"/>';

      
      document.getElementById("contentPage").innerHTML += headerImage;
      break;
  ...
  for (i = 0; i < data.story.content.body.length; i++){
    ...
    switch (data.story.content.body[i].component){
      ...
      navHTMLString += "<ul>";
      navHTMLString += "<li><a class='active' href='http://des-iis.ucn.dk/mmda0918/1074182/Lilleskolerne/index.html'>" + data.story.content.body[i].nav_li1 + "</a></li>";
      navHTMLString += "<li><a href='#'>" + data.story.content.body[i].nav_li2 + "</a></li>";
      navHTMLString += "<li><a href='http://des-iis.ucn.dk/mmda0918/1074182/Lilleskolerne/information/information.html'>" + data.story.content.body[i].nav_li3 + "</a></li>";
      navHTMLString += "</ul>";      
